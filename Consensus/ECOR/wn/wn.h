...
#ifdef ___WINDOWS
#define DICTDIR         "\\dict"
#define DEFAULTPATH	"D:\\WordNet\\2.1\\dict"
...
#else
#define DICTDIR         "dict"
#define DEFAULTPATH	"D:\\WordNet\\dict"
#define DATAFILE	"%sdata.%s"
#define INDEXFILE	"%sindex.%s"
#define SENSEIDXFILE	"%sindex.sense"
#define KEYIDXFILE	"%sindex.key"
#define REVKEYIDXFILE	"%sindex.key.rev"
#define VRBSENTFILE     "%ssents.vrb"
#define VRBIDXFILE	"%ssentidx.vrb"
#define CNTLISTFILE     "%scntlist.rev"
#endif
