...
int utils::parse_args(int argc, char ** argv, model * pmodel) {
	...
	if (dfile == "") {
		if(LDA_PRINTF_ENABLE){
			DOCCOM::LDA_printf("Please specify the input data file for model estimation!\n");
		}
		else{
	...
	if (dir == "") {
		if(LDA_PRINTF_ENABLE){
			DOCCOM::LDA_printf("Please specify model directory!\n");
		}
		else{
	...
	if (model_name == "") {
		if(LDA_PRINTF_ENABLE){
			DOCCOM::LDA_printf("Please specify model name upon that you want to continue estimating!\n");
		}
		else{
	...
	if (dir == "") {
		if(LDA_PRINTF_ENABLE){
			DOCCOM::LDA_printf("Please specify model directory please!\n");
		}
		else{
	...
	if (model_name == "") {
		if(LDA_PRINTF_ENABLE){
			DOCCOM::LDA_printf("Please specify model name for inference!\n");
		}
		else{
	...
	if (dfile == "") {
		if(LDA_PRINTF_ENABLE){
			DOCCOM::LDA_printf("Please specify the new data file for inference!\n");
		}
		else{
    ...
    if (model_status == MODEL_STATUS_UNKNOWN) {
		if(LDA_PRINTF_ENABLE){
			DOCCOM::LDA_printf("Please specify the task you would like to perform (-est/-estc/-inf)!\n");
		}
		else{
...
int utils::read_and_parse(string filename, model * pmodel) {
    ...
    if (!fin) {
		if(LDA_PRINTF_ENABLE){
			DOCCOM::LDA_printf("Cannot open file: %s\n", filename.c_str());
		}
		else{
